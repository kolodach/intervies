...
-- Rename indexes
ALTER INDEX idx_questions_difficulty
RENAME TO idx_problems_difficulty;

ALTER INDEX idx_questions_categories
RENAME TO idx_problems_categories;

ALTER INDEX idx_questions_is_active
RENAME TO idx_problems_is_active;
...
CREATE POLICY "Public can read problems" ON public.problems FOR
SELECT
