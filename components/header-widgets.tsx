...
// Widget: Logo (clickable to go home)
...
// Widget: Breadcrumb title (shows current page context)
export function HeaderTitle() {
  ...
  return (
    <div className="text-sm font-medium overflow-ellipsis line-clamp-1">
      <Breadcrumbs pathSegments={segments.map(formatBreadcrumb)} />
    </div>
  );
}

// Widget: New Interview Button
...
// Widget: Auth Buttons (for non-authenticated users)
