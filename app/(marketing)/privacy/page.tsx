  ...
  return (
    <main className="w-full mx-auto px-4 py-12 flex justify-center">
      <div className="prose prose-invert prose-sm">
        ...
        <p>
          {" "}
          Prep Zero (“we,” “our,” or “us”) is committed to protecting your
          privacy. This Privacy Policy explains how your personal information is
          collected, used, and disclosed by Prep Zero.
        </p>
        <p>
          ...
          Prep Zero. By accessing or using our Service, you signify that you
        ...
        <ul>
          ...
          <li>
            ...
            up to use the Prep Zero Service to manage the relationships with
          ...
          <li>
            Personnel: refers to those individuals who are employed by Prep Zero
        ...
        <h1>
          When does Prep Zero use end user information from third parties?
        </h1>
        <p>
          Prep Zero will collect End User Data necessary to provide the Prep
          Zero services to our customers.
        </p>
        <p>
        ...
        <h1>
          When does Prep Zero use customer information from third parties?
        </h1>
        <p>
          ...
          interest in becoming a Prep Zero customer, we receive information from
          a third party that provides automated fraud detection services to Prep
          Zero. We also occasionally collect information that is made publicly
        ...
        <p>
          Prep Zero will collect personal information that you submit to us. We
        ...
        <p>
          We keep your information only so long as we need it to provide Prep
          Zero to you and fulfill the purposes described in this policy. This is
        ...
        <p>
          ...
          absolute security of any information you transmit to Prep Zero or
        ...
        <p>
          Prep Zero is incorporated in Canada. Information collected via our
        ...
        <h1>
          Is the information collected through the Prep Zero Service secure?
        </h1>
        <p>
        ...
        <p>
          ...
          information Prep Zero collects depend on your relationship with Prep
          Zero. Personnel may update or correct their information as detailed in
        ...
        <p>
          ...
          of the assets of Prep Zero or any of its Corporate Affiliates (as
          defined herein), or that portion of Prep Zero or any of its Corporate
        ...
        <p>
          ...
          Prep Zero, whether by ownership or otherwise. Any information relating
        ...
        <p>
          By using Prep Zero or contacting us directly, you signify your
        ...
        <p>
          ...
          right thing to do. At Prep Zero we strongly believe that your data
        ...
        <p>
          ...
          requirements of GDPR. Prep Zero processes or stores all personal data
