  ...
  return (
    <main className="w-full mx-auto px-4 py-12 flex justify-center">
      <div className="prose prose-invert prose-sm">
        ...
        <p>Updated at 2026-01-01</p>
        <h1>General Terms</h1>
        <p>
          By accessing and placing an order with Prep Zero, you confirm that you
        ...
        <p>
          Under no circumstances shall Prep Zero team be liable for any direct,
          ...
          inability to use, the materials on this site, even if Prep Zero team
        ...
        <p>
          Prep Zero will not be responsible for any outcome that may occur
        ...
        <h1>License</h1>
        <p>
          Prep Zero grants you a revocable, non-exclusive, non-transferable,
          limited license to download, install and use the website strictly in
          accordance with the terms of this Agreement.
        </p>
        <p>
          These Terms & Conditions are a contract between you and Prep Zero
          (referred to in these Terms & Conditions as "Prep Zero", "us", "we" or
          "our"), the provider of the Prep Zero website and the services
          accessible from the Prep Zero website (which are collectively referred
          to in these Terms & Conditions as the "Prep Zero Service").
        </p>
        <p>
          You are agreeing to be bound by these Terms & Conditions. If you do
          not agree to these Terms & Conditions, please do not use the Prep Zero
        ...
        <ul>
          ...
          <li>
            ...
            it refers to Prep Zero, that is responsible for your information
            under this Terms & Conditions.
          </li>
          <li>
            Country: where Prep Zero or the owners/founders of Prep Zero are
            based, in this case is{" "}
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Prep Zero and
            use the services.
          </li>
          <li>
            Service: refers to the service provided by Prep Zero as described in
          ...
          <li>
            Website: Prep Zero's site, which can be accessed via this URL:
            https://prep0.dev
          </li>
          <li>
            You: a person or entity that is registered with Prep Zero to use the
            Services.
          </li>
        </ul>
        <h1>Restrictions</h1>
        ...
        <ul>
          ...
          <li>
            ...
            notice of copyright or trademark) of Prep Zero or its affiliates,
            partners, suppliers or the licensors of the website.
          </li>
        </ul>
        <h1>Return and Refund Policy</h1>
        <p>
          Thanks for shopping at Prep Zero. We appreciate the fact that you like
        ...
        <p>
          ...
          apply to transactions at Prep Zero. We’ll be as brief as our attorneys
          will allow. The main thing to remember is that by placing an order or
          making a purchase at Prep Zero, you agree to the terms along with Prep
          Zero's Privacy Policy.
        </p>
        <p>
        ...
        <p>
          ...
          (collectively, "Suggestions") provided by you to Prep Zero with
          respect to the website shall remain the sole and exclusive property of
          Prep Zero.
        </p>
        <p>
          Prep Zero shall be free to use, copy, modify, publish, or redistribute
        ...
        <p>
          ...
          contain links to other websites not operated or controlled by Prep
          Zero. We are not responsible for the content, accuracy or opinions
        ...
        <h1>Cookies</h1>
        <p>
          Prep Zero uses "Cookies" to identify the areas of our website that you
        ...
        <p>
          You acknowledge and agree that Prep Zero may stop (permanently or
          ...
          do not need to specifically inform Prep Zero when you stop using the
          Service. You acknowledge and agree that if Prep Zero disables access
        ...
        <p>
          Prep Zero reserves the right to modify, suspend or discontinue,
        ...
        <p>
          Prep Zero may from time to time provide enhancements or improvements
        ...
        <p>
          ...
          of the website. You agree that Prep Zero has no obligation to (i)
        ...
        <p>
          You acknowledge and agree that Prep Zero shall not be responsible for
          ...
          or any other aspect thereof. Prep Zero does not assume and shall not
        ...
        <p>
          This Agreement shall remain in effect until terminated by you or Prep
          Zero.
        </p>
        <p>
          Prep Zero may, in its sole discretion, at any time and for any or no
        ...
        <p>
          ...
          Prep Zero, in the event that you fail to comply with any provision of
        ...
        <p>
          Termination of this Agreement will not limit any of Prep Zero's rights
        ...
        <p>
          You agree to indemnify and hold Prep Zero and its parents,
        ...
        <p>
          ...
          permitted under applicable law, Prep Zero, on its own behalf and on
          ...
          trade practice. Without limitation to the foregoing, Prep Zero
        ...
        <p>
          Without limiting the foregoing, neither Prep Zero nor any Prep Zero's
          ...
          the content, or e-mails sent from or on behalf of Prep Zero are free
        ...
        <p>
          ...
          of Prep Zero and any of its suppliers under any provision of this
        ...
        <p>
          ...
          Prep Zero or its suppliers be liable for any special, incidental,
          ...
          provision of this Agreement), even if Prep Zero or any supplier has
        ...
        <p>
          ...
          notices published by Prep Zero on the Services, shall constitute the
          entire agreement between you and Prep Zero concerning the Services. If
          ...
          term or any other term, and Prep Zero's failure to assert any right or
          provision under this Agreement shall not constitute a waiver of such
          right or provision. YOU AND Prep Zero AGREE THAT ANY CAUSE OF ACTION
        ...
        <p>
          Prep Zero reserves the right, at its sole discretion, to modify or
        ...
        <p>
          ...
          agree to the new terms, you are no longer authorized to use Prep Zero.
        </p>
        <h1>Entire Agreement</h1>
        <p>
          The Agreement constitutes the entire agreement between you and Prep
          Zero regarding your use of the website and supersedes all prior and
          contemporaneous written or oral agreements between you and Prep Zero.
        </p>
        <p>
          You may be subject to additional terms and conditions that apply when
          you use or purchase other Prep Zero's services, which Prep Zero will
        ...
        <p>
          ...
          arrangement thereof), are owned by Prep Zero, its licensors or other
          ...
          or in part, without the express prior written permission of Prep Zero,
        ...
        <p>
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Prep Zero's
          INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
          action, or other controversy between you and Prep Zero concerning the
        ...
        <p>
          In the event of a dispute, you or Prep Zero must give the other a
          ...
          <Link href="mailto:oleh@prep0.dev">oleh@prep0.dev</Link>. Prep Zero
          will send any Notice of Dispute to you by mail to your address if we
          have it, or otherwise to your email address. You and Prep Zero will
          ...
          sixty (60) days, you or Prep Zero may commence arbitration.
        </p>
        <h1>Binding Arbitration</h1>
        <p>
          If you and Prep Zero don’t resolve any dispute by informal
        ...
        <p>
          ...
          and will become the sole property of Prep Zero without any
          compensation or credit to you whatsoever. Prep Zero and its affiliates
          shall have no obligations with respect to such submissions or posts
          and may use the ideas contained in such submissions or posts for any
        ...
        <h1>Promotions</h1>
        <p>
          Prep Zero may, from time to time, include contests, promotions,
        ...
        <p>
          ...
          representative of Prep Zero. Prep Zero will be entitled to injunctive
          or other equitable relief (without the obligations of posting any bond
          or surety) in the event of any breach or anticipatory breach by you.
          Prep Zero operates and controls the Prep Zero Service from its offices
          in . The Service is not intended for distribution to or use by any
          person or entity in any jurisdiction or country where such
          distribution or use would be contrary to law or regulation.
          Accordingly, those persons who choose to access the Prep Zero Service
          ...
          incorporate the Prep Zero Privacy Policy) contains the entire
          understanding, and supersedes all prior understandings, between you
          and Prep Zero concerning its subject matter, and cannot be changed or
        ...
        <h1>Disclaimer</h1>
        <p>
          Prep Zero is not responsible for any content, code or any other
          imprecision.
        </p>
        <p>Prep Zero does not provide warranties or guarantees.</p>
        <p>
          In no event shall Prep Zero be liable for any special, direct,
        ...
        <p>
          The Prep Zero Service and its contents are provided "as is" and "as
          available" without any warranty or representations of any kind,
          whether express or implied. Prep Zero is a distributor and not a
          publisher of the content supplied by third parties; as such, Prep Zero
          ...
          accessible via the Prep Zero Service. Without limiting the foregoing,
          Prep Zero specifically disclaims all warranties and representations in
          any content transmitted on or in connection with the Prep Zero Service
          or on sites that may appear as links on the Prep Zero Service, or in
          the products provided as a part of, or otherwise in connection with,
          the Prep Zero Service, including without limitation any warranties of
          merchantability, fitness for a particular purpose or non-infringement
          of third party rights. No oral advice or written information given by
          Prep Zero or any of its affiliates, employees, officers, directors,
          ...
          foregoing, Prep Zero does not warrant that the Prep Zero Service will
        ...
        <ul>
          <li>
            Via Email: <Link href="mailto:oleh@prep0.dev">oleh@prep0.dev</Link>
          </li>
        </ul>{" "}
      </div>
    </main>
